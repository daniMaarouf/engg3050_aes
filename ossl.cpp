 ...
 */
void AES_set_encrypt_key(const unsigned char userKey[32], unsigned char expanded_key[240])
{
 ...
 */
void AES_set_decrypt_key(const unsigned char userKey[32], unsigned char expanded_key[240])
{
    ...
    AES_set_encrypt_key(userKey, expanded_key);
...
void AES_encrypt(const unsigned char in[16], unsigned char out[16],
                 const unsigned char expanded_key[240]) {
